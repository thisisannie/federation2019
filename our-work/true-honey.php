        ...
        <div class="container-fluid">
            <div class="row justify-content-center">
                <div class="project-feature-image">
                    <img src="<?=HTML_ROOT;?>/img/our-work/true-honey/banner.webp" alt="" class="project-feature-image__photo">
                </div>
            </div>
        </div>
    </div>
    <div class="project-stats-container">
				...
				<div class="row justify-content-center">
					<div class="col-12 col-md-10">
						<div class="website-images">
							<img src="<?=HTML_ROOT;?>/img/our-work/true-honey/website.webp" alt="" class="website animate animate--fade-up-25">
							<img src="<?=HTML_ROOT;?>/img/our-work/true-honey/phone.webp" alt="" class="phone animate animate--fade-up-25">
						</div>
					</div>
				</div>
				<div class="row">
			...
			<div class="container-fluid">
				<div class="row justify-content-center">
					<div class="col-12 col-md-6 order-md-2">
						...
						<img src="<?=HTML_ROOT;?>/img/our-work/true-honey/honeycomb.webp" alt="" class="honeycomb animate animate--fade-up-25">
						<img src="<?=HTML_ROOT;?>/img/our-work/true-honey/tab.webp" alt="" class="tab animate animate--fade-up-25">
					</div>
		...
		<div class="section section--white section--project-next">
			<div class="container">
				<div class="row">
					<div class="col-12">
						<a href="<?=HTML_ROOT;?>/our-work/th-lozenge" class="link-button section--project-next__button">Next project</a>
					</div>
				</div>
				<div class="row justify-content-center section--project-next__row">
					<div class="col-12 col-sm-10 col-md-9">
						<a href="<?=HTML_ROOT;?>/our-work/th-lozenge" class="project-next-img">
							...
							<img src="<?=HTML_ROOT;?>/img/our-work/next-project--lozenge-launch.webp" alt="" class="project-next-img__image">
