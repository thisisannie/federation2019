...
<div class="page page--what-we-do">
                ...
                <div class="feature-img">
                    ...
                    <div class="feature-img__text-mask feature-img__text-mask--outer">
                        <div class="feature-img__text feature-img__text--outer">
                            ...
                            <span class="animate animate--slide-left-25">&nbsp;&nbsp;effective</span>
                        </div>
                        <div class="feature-img__text feature-img__text--mobile feature-img__text--outer">
							<span class="animate animate--slide-right-25">100% agile</span><br>
                            <span class="animate animate--slide-left-25">&nbsp;&nbsp;and effective</span>
                        </div>
                    </div>
    ...
    <div class="section section--white section--services">
        <div class="container">
            <div class="row justify-content-center">
                        ...
                        <div class="feature-img__text-mask feature-img__text-mask--outer">
                            <div class="feature-img__text feature-img__text--outer">
                                <div class="infinite-scroll infinite-scroll--forward services-scroll">
                                    <div class="infinite-scroll__container infinite-scroll__container--forward">
                                        <div class="infinite-scroll__content infinite-scroll__content--forward services-text">
										• Experiential • Multi-channel campaigns • TV & content production • Media planning • Brand ideas • Social behaviour change • Customer experience • Performance marketing • Website design&nbsp;
                                        </div>
                                    </div>
                                </div>
                                <div class="infinite-scroll infinite-scroll--reverse services-scroll">
                                    <div class="infinite-scroll__container infinite-scroll__container--reverse">
                                        <div class="infinite-scroll__content infinite-scroll__content--reverse services-text">
										• Brand ideas • Social behaviour change • Customer experience • Performance marketing • Website design • Experiential • Multi-channel campaigns • TV & content production • Media planning&nbsp;
                                        </div>
                                    </div>
                                </div>
                                <div class="infinite-scroll infinite-scroll--forward services-scroll">
