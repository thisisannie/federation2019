...
<div class="page page--recent-news__article">
	...
	<div class="section section--black section--banner">
		<img src="<?=HTML_ROOT;?>/img/news/<?php echo $array['slug']; ?>/<?php echo $array['bannerimg']; ?>" alt="Advertising Agency in Auckland - Federation and Maritime NZ" class="feature-image">
	</div>
