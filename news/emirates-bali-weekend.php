        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-2 col-md-6">
                    <p class="animate animate--fade-up-25 project-intro-company">Emirates</p>
                    <p class="animate animate--fade-up-25 project-intro-description">The beauty of Bali on your doorstep.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="section section--black section--banner">
        <img src="<?=HTML_ROOT;?>/img/news/emirates-bali-weekend/banner.webp" alt="View of Bali" class="feature-image">
    </div>
            ...
            <div class="container">
                        ...
                        <div class="mini-slider__slides-mask animate animate--fade-up-25">
                            <ul class="mini-slider__slides">
                                <li data-slide="1" data-slide-title="OOH video" data-slide-paragraph="" class="mini-slider__slide">
                                    <div class="feature-video feature" id="magical-mondays">
                                       <div class="feature-video__image-group">
                                            <img src="<?=HTML_ROOT;?>/img/news/emirates-bali-weekend/slide-a.webp" alt="Magical Mondays - Fly to Bali daily with Emirates" class="feature-video__image">
                                ...
                                <li data-slide="2" data-slide-title="OOH" data-slide-paragraph="" class="mini-slider__slide">
                                    <img src="<?=HTML_ROOT;?>/img/news/emirates-bali-weekend/slide-b.webp" alt="Emirates out of house street furnature billboard advertising">
                                </li>
                                <li data-slide="3" data-slide-title="Activation" data-slide-paragraph="" class="mini-slider__slide">
                                    <div class="feature-video feature" id="emirates-bali-activation">
                                        <div class="feature-video__image-group">
                                            <img src="<?=HTML_ROOT;?>/img/news/emirates-bali-weekend/slide-c.webp" alt="Emirates out of house interactive activation on the street" class="feature-video__image">
                                            <img src="<?=HTML_ROOT;?>/img/video-play-btn.png" alt="Play" class="feature-video__play-btn">
                                        </div>
                                    </div>
                                </li>
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 offset-md-1">
                        <p class="mini-slider__title animate animate--fade-up-25">OOH video</p>
