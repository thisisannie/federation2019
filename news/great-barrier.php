        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-2 col-md-6">
                    ...
                    <p class="animate animate--fade-up-25 project-intro-description">Getting the recycling message out to Great Barrier Island.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="section section--black section--banner">
        <img src="<?=HTML_ROOT;?>/img/news/great-barrier/Header-Image-1400x600.webp" alt="Auckland Council Great Barrier Island recycling bin" class="feature-image">
    </div>
...
-->
                <div class="col-12 col-sm-8 col-lg-7 col-xl-7">
                    <div class="project-detail__description">
                        <p class="animate animate--fade-up-25">You can’t send junk mail out about good waste habits. So our communication itself was reusable and environmentally friendly, especially for the islands birds.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mini-slider__slides-mask animate animate--fade-up-25">
                            <ul class="mini-slider__slides">
                                <li data-slide="1" data-slide-title="" data-slide-paragraph="" class="mini-slider__slide">
                                    <img src="<?=HTML_ROOT;?>/img/news/great-barrier/Img-01-946x495.webp" alt="Roadside recycling message with cutout birdhouse">
                                </li>
                                <li data-slide="2" data-slide-title="" data-slide-paragraph="" class="mini-slider__slide">
                                    <img src="<?=HTML_ROOT;?>/img/news/great-barrier/Img-02-946x495.webp" alt="Cutout birdhouse innovative idea for re-using cardboard waste">
                                </li>
                            </ul>
                        </div>
                    </div>
