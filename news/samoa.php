        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-2 col-md-6">
                    <p class="animate animate--fade-up-25 project-intro-company">Samoa tourism</p>
                    <p class="animate animate--fade-up-25 project-intro-description">Interrupting busy lives with moments of unique, simple beauty.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="section section--black section--banner">
        <img src="<?=HTML_ROOT;?>/img/news/samoa/banner.jpg" alt="" class="feature-image">
    </div>
            ...
            <div class="container">
                                ...
                                <li data-slide="1" data-slide-title="Digital videos" data-slide-paragraph="" class="mini-slider__slide">
                                    <div class="feature-video feature" id="samoa-news-video-a">
                                       <div class="feature-video__image-group">
                                            <img src="<?=HTML_ROOT;?>/img/news/samoa/exhibition-video.jpg" alt="" class="feature-video__image">
                ...
                <div class="row">
                    <div class="col-12 col-sm-6 col-md-6 offset-md-1">
                        <p class="mini-slider__title animate animate--fade-up-25">Digital videos</p>
