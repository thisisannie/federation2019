<?php 
	...
	$page_description = "The first agency in Aotearoa to be accredited in Business and Climate Change: Towards Net Zero Transmission from the University of Cambridge Institute for Sustainability Leadership";
	...
	$array = [
		...
		"intro" => "Hard to believe it’s been 12 months since we became the first agency in Aotearoa to be accredited in Business and Climate Change: Towards Net Zero Transmission from the University of Cambridge Institute for Sustainability Leadership. Since then we’ve been busy applying our learnings!",
		"slug" => "climate",
			...
			<div class="row justify-content-center">
				<div class="col-12 col-sm-8 col-lg-7 col-xl-7">
					...
					<p class="animate animate--fade-up-25"><a href="https://campaignbrief.co.nz/2022/04/21/federation-becomes-first-creative-agency-in-aotearoa-to-launch-sustainability-consulting/" target="_blank">Read Campaign brief Article: Federation becomes first creative agency in Aotearoa to launch sustainability consulting</a></p>
						<p class="animate animate--fade-up-25">Over the last year we’ve helped a range of organisations and marketers on their journey to net zero. Here are some highlights.</p>
