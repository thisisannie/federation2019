<?php 
    $page_title = "Simparica Taste Test";
    $page_description = "All flea treatments claim to be effective. But first your dog has to eat it. So which one tastes best?";
        ...
        <div class="container">
                ...
                <div class="col-12">
                    <div class="project-feature-header">
                        ...
                        <div class="project-feature-header__text">
                            <span class="animate animate--slide-left-25">Simparica</span><br>
                            <span class="animate animate--slide-right-25">&nbsp;Taste Test</span>
                        </div>
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-2 col-md-6">
                    <p class="animate animate--fade-up-25 project-intro-company">Zoetis</p>
                    <p class="animate animate--fade-up-25 project-intro-description">The flea treatment that goes down a treat.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="section section--black section--banner">
        <img src="<?=HTML_ROOT;?>/img/news/simparica/Header-Image-1400x600.webp" alt="" class="feature-image">
    </div>
...
-->
                <div class="col-12 col-sm-8 col-lg-7 col-xl-7">
                    <div class="project-detail__description">
                        <p class="animate animate--fade-up-25">All flea treatments claim to be effective. But first your dog has to eat it. So which one tastes best? Blindfold a dog and put a Simparica chewable tablet under their nose… they’ll know it’s tasty. And we proved that in a real life “sniff test”.</p>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="mini-slider__slides-mask animate animate--fade-up-25">
                            <ul class="mini-slider__slides">
                                <li data-slide="1" data-slide-title="Title-1" data-slide-paragraph="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam." class="mini-slider__slide">
                                    <div class="feature-video feature" id="simparica-video-b">
                                       <div class="feature-video__image-group">
                                            <img src="<?=HTML_ROOT;?>/img/news/simparica/Img-01-946x495.webp" alt="" class="feature-video__image">
                                ...
                                <li data-slide="2" data-slide-title="Title-2" data-slide-paragraph="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.-2" class="mini-slider__slide">
                                    <div class="feature-video feature" id="simparica-video-c">
                                       <div class="feature-video__image-group">
                                            <img src="<?=HTML_ROOT;?>/img/news/simparica/Img-02-946x495.webp" alt="" class="feature-video__image">
                                            <img src="<?=HTML_ROOT;?>/img/video-play-btn.png" alt="" class="feature-video__play-btn">
                                        </div>
                                    </div>
                                </li>
                                <li data-slide="3" data-slide-title="Title-3" data-slide-paragraph="Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.-3" class="mini-slider__slide">
                                    <img src="<?=HTML_ROOT;?>/img/news/simparica/Img-03-946x495.webp" alt="">
                                </li>
                            </ul>
                        </div>
                    </div>
