        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-12 col-sm-10 offset-sm-2 col-md-6">
                    <p class="animate animate--fade-up-25 project-intro-company"></p>
                    <p class="animate animate--fade-up-25 project-intro-description">Tabitha Harris joins Federation in the newly created role of Brand Director.</p>
                </div>
            </div>
        </div>
    </div>
    <div class="section section--black section--banner">
        <img src="<?=HTML_ROOT;?>/img/news/brand-new/banner.jpg" alt="" class="feature-image">
    </div>
